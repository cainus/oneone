...
Server.prototype.defaultContextHandler = function(context, handler, cb){
  var that = this;
  var req = context.req;
  var res = context.res;
...
Server.prototype._getRepr = function(req, res){
...
Server.prototype._getMethods = function(resource){
...
Server.prototype._setOptionsHandler = function(resource){
...
Server.prototype._assignErrorHandlers = function(){
...
Server.prototype.registerMediaType = function(type, instr, outobj){
  this.mediaTypes.register(type, instr, outobj);
};

Server.prototype.registerStatusResponder = function(type, responder){
  this.statusman.register(type, responder);
};

Server.prototype.registerMediaTypes = function(){
